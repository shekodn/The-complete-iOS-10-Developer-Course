...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/2399953/posts?key=AIzaSyD_01PUwEWrVvfID4YcBj1gufkJRxrJKvU")!
                                ...
                                if results.count > 0{
                                    ...
                                    for result in results {
                                        ...
                                        do{
                                            ...
                                            print("failed to do a specific delete")
                                        }
